...
TO BUILD THE SAMPLES ON WINDOWS 32-bit:
	...
	1) Open Visual Studio.
        2) Open the samples project (FileGDB_API\samples\samples_VS2010.sln).
        ...
        C#
	1) Open Visual Studio.
        2) Open the samples project (FileGDB_API\samplesC#\samplesC#.sln).
        3) In the solution explorer, right click on the solution (the top of the tree) and 
        select "Rebuild Solution". The samples will begin to build. Ignore all warnings. You will
...
of the API. A MS Visual Studio 2010 Solution and Projects are included for 
...
Other limitations of the Esri File Geodatabase API at its initial release:
...
WHAT'S NEW:
    ...
    * Coordinate systems supported updated to match 10.1 PreRelease. (NIM078034)
...
FIXED ISSUES:
    ...
    NIM077629 Correct the Bezier curve buffer documentation in the extended_shapefile_format.pdf, the stated size for a  is wrong.
